...
def infoAdicional():
    messagebox.showinfo("Procesador de Álex", "Procesador de textos")
...
def cerrarDoc():
    valor=messagebox.askretrycancel("Reintentar", "No es posible cerrar el documento, documento bloqueado")
